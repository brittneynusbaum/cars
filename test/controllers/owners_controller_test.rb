...
class OwnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create owner" do
    assert_difference("Owner.count") do
      post owners_url, params: { owner: { name: @owner.name, years_owned: @owner.years_owned } }
    end
  ...
  test "should update owner" do
    patch owner_url(@owner), params: { owner: { name: @owner.name, years_owned: @owner.years_owned } }
